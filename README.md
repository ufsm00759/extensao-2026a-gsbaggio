...
![Apresentação da disciplina](./imagens/Semana1Apresentacao.webp)
...
![Visita ao Hub Incubadora Social 1](./imagens/Semana2VisitaHubis.jpeg)
![Visita ao Hub Incubadora Social 2](./imagens/Semana2VisitaHubis2.jpeg)
...
![Protótipo Visual](./imagens/Semana4PrototipoVisual.png)
...
![Apresentação do Protótipo 1](./imagens/Semana5ApresentacaoPrototipo.jpeg)
![Apresentação do Protótipo 2](./imagens/Semana5ApresentacaoPrototipo2.jpeg)
...
![Avaliações de Habilidades](./imagens/Semana6AvaliacoesHabilidades.jpeg)
...
![Tarefas no quadro](./imagens/Semana8TarefasCaligrafia.jpeg)
...
![Apresentação Oficial 1](./imagens/Semana9ApresentacaoOficial.jpeg)
![Apresentação Oficial 2](./imagens/Semana9Apresentacao2.jpeg)
...
![Listar Requisitos no Quadro](./imagens/Semana10ListarRequisitos.jpeg)
...
![Ambiente de Teste e Produção](./imagens/Semana11AmbienteTesteProd.jpeg)
...
![Conversa com Empreendedora](./imagens/Semana14ConversaComEmpreendedora.jpeg)
...
### 1. (I)nteração Dialógica

Ao longo da disciplina, interagimos com pessoas de realidades muito distintas - empreendedoras que produzem artesanato, bolsistas e gestores do Hub IS. Aprimorei consideravelmente minhas *soft skills* de interação nessa disciplina. Aprendi a escutar as necessidades reais dos nossos "clientes", o que, na prática, enriquece o conhecimento empírico de forma que a teoria, por si só, dificilmente proporciona. Muitas disciplinas da graduação priorizam o desenvolvimento do saber teórico; uma cadeira que rompe esse paradigma e explora outra faceta do aprendizado revelou-se uma experiência genuinamente inédita. Na primeira apresentação, cometi algumas enfadonhas gafes memoráveis - mas, nas interações subsequentes, cheguei a um nível de proficiência comunicativa que, ousaria dizer, chega a ser de uma pessoa mediana em oratória.
...
Essa percepção se aprofundou em um momento peculiar: enquanto treinava na academia com um amigo do curso de Direito, relatei a ele sobre o projeto que eu tinha com a Incubadora Social. Ele me disse que era "mais do que minha obrigação" retribuir à comunidade tudo que os recursos públicos me proporcionam na UFSM. A frase ressoou.

---

### 3. (I)mpacto na Formação

Esta foi, sem dúvidas, a disciplina em que mais acumulei conhecimentos aplicáveis à vida real. Das *soft skills* às *hard skills*, do *vibe coding* à comunicação com indivíduos não técnicos - a amplitude do que aprendi é difícil de mensurar. Dentre os conhecimentos, aprendi a estruturar ambientes em estágios (`Local → Teste → Staging → Produção`), a documentar contratos de API, novas stacks e *frameworks*, a praticar SDD de forma concreta e a elaborar apresentações para públicos leigos em tecnologia.

> *"Diga-me e eu esquecerei. Ensine-me e eu me lembrarei. Envolva-me e eu aprenderei."* - Benjamin Franklin

Eu percebi todo o conhecimento que eu obtive quando precisei desenvolver um *software* em uma *hackathon*. As ferramentas de Inteligência Artificial, métodos e *frameworks* que eu aprendi na disciplina foram fundamentais para que eu conseguisse desenvolver o *software*. O resultado não tinha como ser diferente: ficamos no pódio.

---

### 4. (I)nterdisciplinaridade

Essa dimensão manifestou-se com maior intensidade na segunda metade da disciplina, quando estabelecemos interlocução com alunas de áreas artísticas. Nunca havia travado diálogos acadêmicos substantivos com pessoas das áreas "humanas" dentro da universidade. Embora as produções da aluna Sophia, no momento em que redijo este relatório, ainda não tenham sido incorporadas ao projeto, acredito que o trabalho dela agregará valor significativo à plataforma. Além disso, essa experiência me permitiu compreender perspectivas completamente distintas da minha - como a visão que estudantes de Desenho Industrial constroem diante do advento da Inteligência Artificial e algumas particularidades do seu percurso formativo (como algumas disciplinas e conhecimentos técnicos que eu não pensava que eles tinham).

---

### 5. (I)ndissociabilidade

A indissociabilidade entre ensino, pesquisa e extensão quiçá seja o princípio que mais se materializou ao longo da disciplina. Em nenhum momento o projeto pareceu uma atividade isolada do que aprendemos em sala: cada decisão técnica era, simultaneamente, um aprendizado; cada interação com o Hub IS era, ao mesmo tempo, pesquisa aplicada e ação extensionista. Ensino, pesquisa e extensão não foram conceitos abstratos nessa cadeira - foram a própria substância do que vivemos.

> *"A educação é a arma mais poderosa que você pode usar para mudar o mundo."* - Nelson Mandela

---

Com isso, termino meu relato desejando uma sincera boa sorte para o futuro da Vitrine Social.

> *"O Hub IS são os aprendizados que fazemos no caminho."* - Gabriel Souza Baggio